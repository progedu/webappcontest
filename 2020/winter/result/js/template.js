...
setAwardData($(".nprep.tech-prize"), datas.filter( e => e.category === "N予備校" && e.award === "技能特別賞")[0]);
setAwardData($(".nprep.design-prize"), datas.filter( e => e.category === "N予備校" && e.award === "デザイン特別賞")[0]);
